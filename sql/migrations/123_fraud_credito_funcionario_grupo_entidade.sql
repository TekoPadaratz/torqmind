-- 123: Crédito funcionário — origem ENTIDADES grupo 12 (sem join FUNCIONARIOS/CPF).
...
COMMENT ON FUNCTION etl.refresh_fraud_credito_funcionario(integer, integer) IS
  'Refresh crédito funcionário: ENTIDADES grupo 12; uso CR por id_entidade empresa-wide; operador via cupom/NFE; doc=NF.';
