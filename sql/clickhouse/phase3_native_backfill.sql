-- ============================================================================
-- FASE 3: Native Backfill (ClickHouse DW -> Mart)
-- ============================================================================
-- Gerado a partir de phase2_mvs_streaming_triggers.sql
...
-- 2) torqmind_mart.agg_vendas_hora
...
-- 3) torqmind_mart.agg_produtos_diaria
...
-- 4) torqmind_mart.agg_grupos_diaria
...
-- 5) torqmind_mart.agg_funcionarios_diaria
...
-- 6) torqmind_mart.insights_base_diaria
...
-- 7) torqmind_mart.fraude_cancelamentos_diaria
...
-- 8) torqmind_mart.fraude_cancelamentos_eventos
...
-- 10) torqmind_mart.risco_top_funcionarios_diaria
...
-- 11) torqmind_mart.risco_turno_local_diaria
...
-- 13) torqmind_mart.customer_rfm_daily
INSERT INTO torqmind_mart.customer_rfm_daily
SELECT
    today() AS dt_ref,
    v.id_empresa,
    v.id_filial,
...
-- 14) torqmind_mart.customer_churn_risk_daily
INSERT INTO torqmind_mart.customer_churn_risk_daily
SELECT
    today() AS dt_ref,
    v.id_empresa,
    v.id_filial,
...
-- 15) torqmind_mart.financeiro_vencimentos_diaria
...
-- 16) torqmind_mart.finance_aging_daily
...
-- 20) torqmind_mart.agg_caixa_turno_aberto
...
-- 23) torqmind_mart.alerta_caixa_aberto
...
-- 24) torqmind_mart.anonymous_retention_daily
...
-- 25) torqmind_mart.health_score_daily
