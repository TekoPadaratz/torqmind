...
# Default 5 min — reduz pressão de I/O no PG vs */2 histórico.
# Override: OPERATIONAL_INTERVAL_MINUTES=2 se mart operacional precisar mais fresco.
OPERATIONAL_INTERVAL_MINUTES="${OPERATIONAL_INTERVAL_MINUTES:-5}"
