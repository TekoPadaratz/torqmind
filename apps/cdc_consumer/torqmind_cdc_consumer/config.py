...
class Settings(BaseSettings):
    ...
    cdc_topics: str = (
        ...
        "torqmind.stg.entidades,"
        "torqmind.stg.localvendas,"
        "torqmind.stg.financeiro,"
        "torqmind.stg.controle_troca_pgto,"
        "torqmind.stg.movlctoscancelados,"
        "torqmind.stg.planodecontas,"
