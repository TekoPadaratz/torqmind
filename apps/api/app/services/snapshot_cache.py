...
ROUTE_SNAPSHOT_BYPASS_KEYS = frozenset(HOT_ROUTE_REFRESH_AFTER_SECONDS.keys())
SYNC_SNAPSHOT_KEYS = tuple(
    key for key in HOT_ROUTE_REFRESH_AFTER_SECONDS.keys() if key not in ROUTE_SNAPSHOT_BYPASS_KEYS
)
