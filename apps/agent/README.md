...
Defaults novos de configuração priorizam:
- `ODBC Driver 18 for SQL Server`
- `encrypt = true`
- `trust_server_certificate = false`

Se o SQL Server do cliente ainda usa certificado interno/não confiável, ajuste isso explicitamente no `config.enc` em vez de depender de defaults permissivos.
